...
# Teil Person 2: Varianz, Standardabweichung
############################################################
...
# 6) Funktion für Kennwerte: Mittelwert, Median, Modus, Varianz, SD --------
kennwerte <- function(x, name) {
  ...
  data.frame(
    ...
    var      = var(x_clean),  # Varianz
    sd       = sd(x_clean)    # Standardabweichung
  )
}
